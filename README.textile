...
** __int__, __long__, __float__, __double__, __short__ for different number type you require
** _list_ for an array
...
h3. Mapping to a tuple with not found JsonXPath or bad type
...
child1: Option[dispatch.json.JsObject] = Some({"child11" : {"child112" : "blabla"}})
child112: Option[BigDecimal] = None
child21: Option[BigDecimal] = Some(12345)
child22: Option[List[dispatch.json.JsValue]] = None
		
p. Please remark:
* *None* is returned when:
** the JsonXPath is not found in the JsValue
